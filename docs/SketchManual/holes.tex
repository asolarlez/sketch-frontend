...
Sketch supports the use of the $\$$(type) construct to instruct the synthesizer to consider all variables of the specified \C{type} within scope when searching for a solution. 
