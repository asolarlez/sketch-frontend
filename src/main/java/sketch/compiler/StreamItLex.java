...
public StreamItLex(LexerSharedInputState state) {
	...
	literals.put(new ANTLRHashString("complex", this), new Integer(13));
	literals.put(new ANTLRHashString("false", this), new Integer(26));
	literals.put(new ANTLRHashString("true", this), new Integer(25));
	literals.put(new ANTLRHashString("void", this), new Integer(11));
	literals.put(new ANTLRHashString("float", this), new Integer(8));
	...
	literals.put(new ANTLRHashString("continue", this), new Integer(23));
	literals.put(new ANTLRHashString("while", this), new Integer(17));
	literals.put(new ANTLRHashString("break", this), new Integer(22));
	literals.put(new ANTLRHashString("new", this), new Integer(6));
	literals.put(new ANTLRHashString("return", this), new Integer(24));
	literals.put(new ANTLRHashString("assert", this), new Integer(28));
	literals.put(new ANTLRHashString("bit", this), new Integer(9));
	...
	literals.put(new ANTLRHashString("struct", this), new Integer(14));
