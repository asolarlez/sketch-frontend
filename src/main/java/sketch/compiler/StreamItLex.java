...
public StreamItLex(LexerSharedInputState state) {
	...
	literals.put(new ANTLRHashString("switch", this), new Integer(20));
	literals.put(new ANTLRHashString("case", this), new Integer(21));
	literals.put(new ANTLRHashString("loop", this), new Integer(4));
	literals.put(new ANTLRHashString("for", this), new Integer(19));
	literals.put(new ANTLRHashString("ploop", this), new Integer(5));
	literals.put(new ANTLRHashString("complex", this), new Integer(14));
	literals.put(new ANTLRHashString("false", this), new Integer(27));
	literals.put(new ANTLRHashString("true", this), new Integer(26));
	literals.put(new ANTLRHashString("void", this), new Integer(12));
	literals.put(new ANTLRHashString("float", this), new Integer(9));
	literals.put(new ANTLRHashString("boolean", this), new Integer(8));
	literals.put(new ANTLRHashString("implements", this), new Integer(28));
	literals.put(new ANTLRHashString("continue", this), new Integer(24));
	literals.put(new ANTLRHashString("while", this), new Integer(18));
	literals.put(new ANTLRHashString("anyorder", this), new Integer(7));
	literals.put(new ANTLRHashString("break", this), new Integer(23));
	literals.put(new ANTLRHashString("new", this), new Integer(6));
	literals.put(new ANTLRHashString("return", this), new Integer(25));
	literals.put(new ANTLRHashString("assert", this), new Integer(29));
	...
	literals.put(new ANTLRHashString("struct", this), new Integer(15));
