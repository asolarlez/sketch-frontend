...
public StreamItLex(LexerSharedInputState state) {
	...
	literals.put(new ANTLRHashString("case", this), new Integer(23));
	literals.put(new ANTLRHashString("loop", this), new Integer(4));
	literals.put(new ANTLRHashString("for", this), new Integer(21));
	...
	literals.put(new ANTLRHashString("implements", this), new Integer(30));
	literals.put(new ANTLRHashString("continue", this), new Integer(26));
	...
	literals.put(new ANTLRHashString("break", this), new Integer(25));
	literals.put(new ANTLRHashString("new", this), new Integer(6));
	literals.put(new ANTLRHashString("return", this), new Integer(27));
	literals.put(new ANTLRHashString("assert", this), new Integer(31));
	literals.put(new ANTLRHashString("bit", this), new Integer(12));
	literals.put(new ANTLRHashString("if", this), new Integer(18));
	...
	literals.put(new ANTLRHashString("else", this), new Integer(19));
}
