...
public StreamItLex(LexerSharedInputState state) {
	...
	literals.put(new ANTLRHashString("switch", this), new Integer(39));
	...
	literals.put(new ANTLRHashString("for", this), new Integer(38));
	literals.put(new ANTLRHashString("init", this), new Integer(19));
	literals.put(new ANTLRHashString("pi", this), new Integer(45));
	literals.put(new ANTLRHashString("peek", this), new Integer(23));
	literals.put(new ANTLRHashString("phase", this), new Integer(22));
	literals.put(new ANTLRHashString("complex", this), new Integer(32));
	...
	literals.put(new ANTLRHashString("boolean", this), new Integer(26));
	literals.put(new ANTLRHashString("enqueue", this), new Integer(18));
	literals.put(new ANTLRHashString("handler", this), new Integer(10));
	literals.put(new ANTLRHashString("template", this), new Integer(34));
	...
	literals.put(new ANTLRHashString("push", this), new Integer(25));
	literals.put(new ANTLRHashString("pop", this), new Integer(24));
	...
	literals.put(new ANTLRHashString("bit", this), new Integer(28));
	...
	literals.put(new ANTLRHashString("struct", this), new Integer(33));
