...
public StreamItLex(LexerSharedInputState state) {
	...
	literals.put(new ANTLRHashString("switch", this), new Integer(21));
	literals.put(new ANTLRHashString("atomic", this), new Integer(8));
	literals.put(new ANTLRHashString("case", this), new Integer(22));
