...
public StreamItLex(LexerSharedInputState state) {
	...
	literals.put(new ANTLRHashString("h_assert", this), new Integer(41));
	literals.put(new ANTLRHashString("case", this), new Integer(28));
	...
	literals.put(new ANTLRHashString("global", this), new Integer(47));
	...
	literals.put(new ANTLRHashString("harness", this), new Integer(43));
	literals.put(new ANTLRHashString("stencil", this), new Integer(49));
	literals.put(new ANTLRHashString("until", this), new Integer(37));
	...
	literals.put(new ANTLRHashString("library", this), new Integer(44));
	literals.put(new ANTLRHashString("device", this), new Integer(46));
	literals.put(new ANTLRHashString("into", this), new Integer(7));
	literals.put(new ANTLRHashString("serial", this), new Integer(48));
	...
	literals.put(new ANTLRHashString("printfcn", this), new Integer(45));
	literals.put(new ANTLRHashString("repeat", this), new Integer(9));
	literals.put(new ANTLRHashString("pragma", this), new Integer(51));
	literals.put(new ANTLRHashString("include", this), new Integer(50));
	...
	literals.put(new ANTLRHashString("assert", this), new Integer(40));
	...
	literals.put(new ANTLRHashString("default", this), new Integer(29));
	literals.put(new ANTLRHashString("struct", this), new Integer(21));
	literals.put(new ANTLRHashString("generator", this), new Integer(42));
	literals.put(new ANTLRHashString("else", this), new Integer(24));
	literals.put(new ANTLRHashString("by", this), new Integer(38));
	literals.put(new ANTLRHashString("parfor", this), new Integer(36));
}
