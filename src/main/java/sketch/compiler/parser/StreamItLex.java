...
public StreamItLex(LexerSharedInputState state) {
	...
	literals.put(new ANTLRHashString("stencil", this), new Integer(54));
	...
	literals.put(new ANTLRHashString("serial", this), new Integer(52));
	...
	literals.put(new ANTLRHashString("pragma", this), new Integer(56));
	...
	literals.put(new ANTLRHashString("package", this), new Integer(57));
