...
public StreamItLex(LexerSharedInputState state) {
	...
	literals.put(new ANTLRHashString("switch", this), new Integer(30));
	literals.put(new ANTLRHashString("atomic", this), new Integer(4));
	literals.put(new ANTLRHashString("h_assert", this), new Integer(46));
	...
	literals.put(new ANTLRHashString("assert_max", this), new Integer(45));
	literals.put(new ANTLRHashString("void", this), new Integer(19));
	literals.put(new ANTLRHashString("float", this), new Integer(16));
	literals.put(new ANTLRHashString("boolean", this), new Integer(15));
	literals.put(new ANTLRHashString("harness", this), new Integer(48));
	literals.put(new ANTLRHashString("stencil", this), new Integer(53));
	literals.put(new ANTLRHashString("until", this), new Integer(41));
	literals.put(new ANTLRHashString("implements", this), new Integer(43));
	literals.put(new ANTLRHashString("continue", this), new Integer(36));
	literals.put(new ANTLRHashString("do", this), new Integer(35));
	literals.put(new ANTLRHashString("fun", this), new Integer(21));
	...
	literals.put(new ANTLRHashString("extends", this), new Integer(57));
	literals.put(new ANTLRHashString("serial", this), new Integer(51));
	literals.put(new ANTLRHashString("reorder", this), new Integer(13));
	literals.put(new ANTLRHashString("insert", this), new Integer(6));
	literals.put(new ANTLRHashString("ref", this), new Integer(24));
	...
	literals.put(new ANTLRHashString("pragma", this), new Integer(55));
	literals.put(new ANTLRHashString("include", this), new Integer(54));
	literals.put(new ANTLRHashString("model", this), new Integer(49));
	literals.put(new ANTLRHashString("break", this), new Integer(34));
	literals.put(new ANTLRHashString("new", this), new Integer(11));
	literals.put(new ANTLRHashString("return", this), new Integer(37));
	literals.put(new ANTLRHashString("spmdfork", this), new Integer(52));
	literals.put(new ANTLRHashString("assert", this), new Integer(44));
	literals.put(new ANTLRHashString("repeat_case", this), new Integer(32));
	literals.put(new ANTLRHashString("bit", this), new Integer(17));
	...
	literals.put(new ANTLRHashString("double", this), new Integer(20));
	...
	literals.put(new ANTLRHashString("package", this), new Integer(56));
	literals.put(new ANTLRHashString("generator", this), new Integer(47));
	literals.put(new ANTLRHashString("else", this), new Integer(27));
	literals.put(new ANTLRHashString("adt", this), new Integer(25));
	literals.put(new ANTLRHashString("by", this), new Integer(42));
	literals.put(new ANTLRHashString("parfor", this), new Integer(40));
}
