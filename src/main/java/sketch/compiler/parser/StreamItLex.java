...
public StreamItLex(LexerSharedInputState state) {
	...
	literals.put(new ANTLRHashString("h_assert", this), new Integer(45));
	...
	literals.put(new ANTLRHashString("global", this), new Integer(49));
	literals.put(new ANTLRHashString("assert_max", this), new Integer(44));
	...
	literals.put(new ANTLRHashString("harness", this), new Integer(47));
	literals.put(new ANTLRHashString("stencil", this), new Integer(52));
	literals.put(new ANTLRHashString("until", this), new Integer(40));
	literals.put(new ANTLRHashString("implements", this), new Integer(42));
	literals.put(new ANTLRHashString("continue", this), new Integer(35));
	...
	literals.put(new ANTLRHashString("extends", this), new Integer(56));
	literals.put(new ANTLRHashString("serial", this), new Integer(50));
	...
	literals.put(new ANTLRHashString("while", this), new Integer(27));
	literals.put(new ANTLRHashString("repeat", this), new Integer(9));
	literals.put(new ANTLRHashString("pragma", this), new Integer(54));
	literals.put(new ANTLRHashString("include", this), new Integer(53));
	literals.put(new ANTLRHashString("model", this), new Integer(48));
	literals.put(new ANTLRHashString("break", this), new Integer(33));
	literals.put(new ANTLRHashString("new", this), new Integer(11));
	literals.put(new ANTLRHashString("return", this), new Integer(36));
	literals.put(new ANTLRHashString("spmdfork", this), new Integer(51));
	literals.put(new ANTLRHashString("assert", this), new Integer(43));
	literals.put(new ANTLRHashString("repeat_case", this), new Integer(31));
	...
	literals.put(new ANTLRHashString("generator", this), new Integer(46));
	literals.put(new ANTLRHashString("else", this), new Integer(26));
	literals.put(new ANTLRHashString("by", this), new Integer(41));
	literals.put(new ANTLRHashString("parfor", this), new Integer(39));
}
