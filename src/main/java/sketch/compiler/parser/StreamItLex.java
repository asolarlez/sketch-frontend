...
public StreamItLex(LexerSharedInputState state) {
	...
	literals.put(new ANTLRHashString("case", this), new Integer(26));
	literals.put(new ANTLRHashString("loop", this), new Integer(8));
	literals.put(new ANTLRHashString("for", this), new Integer(24));
	literals.put(new ANTLRHashString("complex", this), new Integer(18));
	...
	literals.put(new ANTLRHashString("float", this), new Integer(13));
	literals.put(new ANTLRHashString("boolean", this), new Integer(12));
	literals.put(new ANTLRHashString("implements", this), new Integer(34));
	literals.put(new ANTLRHashString("continue", this), new Integer(30));
	literals.put(new ANTLRHashString("do", this), new Integer(29));
	literals.put(new ANTLRHashString("null", this), new Integer(10));
	literals.put(new ANTLRHashString("into", this), new Integer(7));
	literals.put(new ANTLRHashString("reorder", this), new Integer(11));
	literals.put(new ANTLRHashString("insert", this), new Integer(6));
	literals.put(new ANTLRHashString("ref", this), new Integer(20));
	literals.put(new ANTLRHashString("static", this), new Integer(36));
	literals.put(new ANTLRHashString("while", this), new Integer(23));
	literals.put(new ANTLRHashString("pragma", this), new Integer(38));
	literals.put(new ANTLRHashString("include", this), new Integer(37));
	literals.put(new ANTLRHashString("break", this), new Integer(28));
	literals.put(new ANTLRHashString("new", this), new Integer(9));
	literals.put(new ANTLRHashString("return", this), new Integer(31));
	literals.put(new ANTLRHashString("assert", this), new Integer(35));
	literals.put(new ANTLRHashString("bit", this), new Integer(14));
	literals.put(new ANTLRHashString("if", this), new Integer(21));
	literals.put(new ANTLRHashString("int", this), new Integer(15));
	literals.put(new ANTLRHashString("double", this), new Integer(17));
	literals.put(new ANTLRHashString("fork", this), new Integer(5));
	literals.put(new ANTLRHashString("default", this), new Integer(27));
