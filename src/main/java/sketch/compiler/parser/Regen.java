...
// on Friday, January 9, 2009 at 12:59:51 AM.
...
public final class Regen extends ParserBase {
  ...
  /**
   * Parse nonterminal streamit.frontend.parser.Regen.ExprFuncInvok.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
  ...
  /**
   * Parse nonterminal streamit.frontend.parser.Regen.ArgList.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
  ...
  private Result pSelChain(final int yyStart) throws IOException {
    RegenColumn yyColumn = (RegenColumn)column(yyStart);
    if (null == yyColumn.chunk2) yyColumn.chunk2 = new Chunk2();
    if (null == yyColumn.chunk2.fSelChain) 
      yyColumn.chunk2.fSelChain = pSelChain$1(yyStart);
    return yyColumn.chunk2.fSelChain;
  }
  ...
  /** Actually parse streamit.frontend.parser.Regen.Var. */
