...
// Rats! Parser Generator, version 1.13.3,
// (C) 2004-2008 Robert Grimm,
// on Thursday, April 17, 2008 at 9:33:53 PM.
...
import static streamit.frontend.nodes.ExprChoiceSelect.SelectOrr;
 ...
 * generator, version 1.13.3, (C) 2004-2008 Robert Grimm.
 */
public final class Regen extends ParserBase {
  ...
  /**
   * Parse nonterminal streamit.frontend.parser.Regen.NestedRegen.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pNestedRegen(final int yyStart) throws IOException {
    Result     yyResult;
    Expression yyValue;
    ParseError yyError = ParseError.DUMMY;
    ...
    yyResult = pRegenLiteral(yyStart);
    yyError  = yyResult.select(yyError);
    if (yyResult.hasValue()) {
      String r = yyResult.semanticValue();

      yyValue = new ExprParen (RegenParser.parse (r));
  ...
  /**
   * Parse nonterminal streamit.frontend.parser.Regen.RegenLiteral.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pRegenLiteral(final int yyStart) throws IOException {
    int        yyC;
    int        yyIndex;
    Result     yyResult;
    int        yyBase;
    ...
    if ('{' == yyC) {
      ...
      if ('|' == yyC) {
        ...
        yyResult = pRegenLiteral$$Choice1(yyIndex);
        yyError  = yyResult.select(yyError);
        if (yyResult.hasValue()) {
          yyValue = yyResult.semanticValue();
    ...
    // Done.
    yyError = yyError.select("regen literal expected", yyStart);
    return yyError;
  }
  ...
  /**
   * Parse synthetic nonterminal 
   * streamit.frontend.parser.Regen.RegenLiteral$$Choice1.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pRegenLiteral$$Choice1(final int yyStart) 
    throws IOException {
  ...
  /**
   * Parse nonterminal streamit.frontend.parser.Regen.Keyword.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
  ...
  private Result pKeyword(final int yyStart) throws IOException {
    RegenColumn yyColumn = (RegenColumn)column(yyStart);
    if (null == yyColumn.chunk3) yyColumn.chunk3 = new Chunk3();
    if (null == yyColumn.chunk3.fKeyword) 
      yyColumn.chunk3.fKeyword = pKeyword$1(yyStart);
    return yyColumn.chunk3.fKeyword;
  }

  /** Actually parse streamit.frontend.parser.Regen.Keyword. */
  ...
  /**
   * Parse nonterminal streamit.frontend.parser.Regen.KW.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
