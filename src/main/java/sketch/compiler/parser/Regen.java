...
import sketch.compiler.ast.core.exprs.ExprChoiceSelect.Select;
...
import sketch.compiler.ast.core.exprs.ExprChoiceSelect.Selector;
...
public final class Regen extends ParserBase {
  ...
  /**
   * Parse synthetic nonterminal 
   * sketch.compiler.parser.Regen.ExprBin$$Star1.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
  ...
  /**
   * Parse synthetic nonterminal 
   * sketch.compiler.parser.Regen.SelChain$$Star1.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
