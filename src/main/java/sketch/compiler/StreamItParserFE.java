  ...
  tokenNames = _tokenNames;
	...
	public final StreamSpec  filter_body(
		...
		try {      // for error handling
			...
			do {
				...
				default:
					boolean synPredMatched6905 = false;
					if (((_tokenSet_0.member(LA(1))))) {
						int _m6905 = mark();
						synPredMatched6905 = true;
						inputState.guessing++;
						try {
							{
							data_type();
							...
							synPredMatched6905 = false;
						}
						rewind(_m6905);
						inputState.guessing--;
					}
					if ( synPredMatched6905 ) {
						fn=function_decl();
						if ( inputState.guessing==0 ) {
							funcs.add(fn);
						}
	...
	public final Statement  statement() throws RecognitionException, TokenStreamException {
		...
		try {      // for error handling
			...
			default:
				boolean synPredMatched6928 = false;
				if (((_tokenSet_0.member(LA(1))))) {
					int _m6928 = mark();
					synPredMatched6928 = true;
					inputState.guessing++;
					try {
						{
						data_type();
						...
						synPredMatched6928 = false;
					}
					rewind(_m6928);
					inputState.guessing--;
				}
				if ( synPredMatched6928 ) {
					s=variable_decl();
					match(SEMI);
				}
				else {
					boolean synPredMatched6930 = false;
					if (((_tokenSet_15.member(LA(1))))) {
						int _m6930 = mark();
						synPredMatched6930 = true;
						inputState.guessing++;
						try {
							{
							expr_statement();
							...
							synPredMatched6930 = false;
						}
						rewind(_m6930);
						inputState.guessing--;
					}
					if ( synPredMatched6930 ) {
						s=expr_statement();
						match(SEMI);
					}
					else if ((LA(1)==ID)) {
	...
	public final Statement  expr_statement() throws RecognitionException, TokenStreamException {
		...
		try {      // for error handling
			boolean synPredMatched7008 = false;
			if (((LA(1)==INCREMENT||LA(1)==DECREMENT||LA(1)==ID))) {
				int _m7008 = mark();
				synPredMatched7008 = true;
				inputState.guessing++;
				try {
					{
					incOrDec();
					...
					synPredMatched7008 = false;
				}
				rewind(_m7008);
				inputState.guessing--;
			}
			if ( synPredMatched7008 ) {
				x=incOrDec();
				if ( inputState.guessing==0 ) {
					s = new StmtExpr(x);
				}
				...
				boolean synPredMatched7011 = false;
				if (((LA(1)==ID))) {
					int _m7011 = mark();
					synPredMatched7011 = true;
					inputState.guessing++;
					try {
						{
						left_expr();
						...
						synPredMatched7011 = false;
					}
					rewind(_m7011);
					inputState.guessing--;
				}
				if ( synPredMatched7011 ) {
					s=assign_expr();
				}
				else {
					boolean synPredMatched7013 = false;
					if (((LA(1)==ID))) {
						int _m7013 = mark();
						synPredMatched7013 = true;
						inputState.guessing++;
						try {
							{
							match(ID);
							...
							synPredMatched7013 = false;
						}
						rewind(_m7013);
						inputState.guessing--;
					}
					if ( synPredMatched7013 ) {
						x=func_call();
						if ( inputState.guessing==0 ) {
							s = new StmtExpr(x);
						}
	...
	public final Statement  if_else_statement() throws RecognitionException, TokenStreamException {
		...
		try {      // for error handling
			...
			t=statement();
			{
			boolean synPredMatched6992 = false;
			if (((LA(1)==TK_else))) {
				int _m6992 = mark();
				synPredMatched6992 = true;
				inputState.guessing++;
				try {
					{
					match(TK_else);
					...
					synPredMatched6992 = false;
				}
				rewind(_m6992);
				inputState.guessing--;
			}
			if ( synPredMatched6992 ) {
				{
				match(TK_else);
				f=statement();
				}
	...
	public final StreamCreator  stream_creator() throws RecognitionException, TokenStreamException {
		...
		try {      // for error handling
			boolean synPredMatched6936 = false;
			if (((_tokenSet_18.member(LA(1))))) {
				int _m6936 = mark();
				synPredMatched6936 = true;
				inputState.guessing++;
				try {
					{
					switch ( LA(1)) {
					...
					synPredMatched6936 = false;
				}
				rewind(_m6936);
				inputState.guessing--;
			}
			if ( synPredMatched6936 ) {
				sc=anonymous_stream();
			}
			else if ((LA(1)==ID)) {
				sc=named_stream();
	...
	public final SplitterJoiner  splitter_or_joiner() throws RecognitionException, TokenStreamException {
		...
		try {      // for error handling
			...
			case TK_roundrobin:
			{
				...
				match(TK_roundrobin);
				{
				boolean synPredMatched6955 = false;
				if (((LA(1)==LPAREN))) {
					int _m6955 = mark();
					synPredMatched6955 = true;
					inputState.guessing++;
					try {
						{
						match(LPAREN);
						...
						synPredMatched6955 = false;
					}
					rewind(_m6955);
					inputState.guessing--;
				}
				if ( synPredMatched6955 ) {
					match(LPAREN);
					match(RPAREN);
					if ( inputState.guessing==0 ) {
					...
					boolean synPredMatched6957 = false;
					if (((LA(1)==LPAREN))) {
						int _m6957 = mark();
						synPredMatched6957 = true;
						inputState.guessing++;
						try {
							{
							match(LPAREN);
							...
							synPredMatched6957 = false;
						}
						rewind(_m6957);
						inputState.guessing--;
					}
					if ( synPredMatched6957 ) {
						match(LPAREN);
						x=right_expr();
						match(RPAREN);
						if ( inputState.guessing==0 ) {
	...
	public final Statement  for_init_statement() throws RecognitionException, TokenStreamException {
		...
		try {      // for error handling
			boolean synPredMatched7000 = false;
			if (((_tokenSet_0.member(LA(1))))) {
				int _m7000 = mark();
				synPredMatched7000 = true;
				inputState.guessing++;
				try {
					{
					variable_decl();
					...
					synPredMatched7000 = false;
				}
				rewind(_m7000);
				inputState.guessing--;
			}
			if ( synPredMatched7000 ) {
				s=variable_decl();
			}
			else {
				boolean synPredMatched7002 = false;
				if (((_tokenSet_15.member(LA(1))))) {
					int _m7002 = mark();
					synPredMatched7002 = true;
					inputState.guessing++;
					try {
						{
						expr_statement();
						...
						synPredMatched7002 = false;
					}
					rewind(_m7002);
					inputState.guessing--;
				}
				if ( synPredMatched7002 ) {
					s=expr_statement();
				}
				else {
					boolean synPredMatched7004 = false;
					if (((LA(1)==SEMI))) {
						int _m7004 = mark();
						synPredMatched7004 = true;
						inputState.guessing++;
						try {
							{
							match(SEMI);
							...
							synPredMatched7004 = false;
						}
						rewind(_m7004);
						inputState.guessing--;
					}
					if ( synPredMatched7004 ) {
						if ( inputState.guessing==0 ) {
	...
	public final Expression  castExpr() throws RecognitionException, TokenStreamException {
		...
		try {      // for error handling
			boolean synPredMatched7058 = false;
			if (((LA(1)==LPAREN))) {
				int _m7058 = mark();
				synPredMatched7058 = true;
				inputState.guessing++;
				try {
					{
					match(LPAREN);
					...
					synPredMatched7058 = false;
				}
				rewind(_m7058);
				inputState.guessing--;
			}
			if ( synPredMatched7058 ) {
				{
				l = LT(1);
				match(LPAREN);
				t=primitive_type();
	...
	public final Expression  inc_dec_expr() throws RecognitionException, TokenStreamException {
		...
		try {      // for error handling
			boolean synPredMatched7067 = false;
			if (((LA(1)==INCREMENT||LA(1)==DECREMENT||LA(1)==ID))) {
				int _m7067 = mark();
				synPredMatched7067 = true;
				inputState.guessing++;
				try {
					{
					incOrDec();
					...
					synPredMatched7067 = false;
				}
				rewind(_m7067);
				inputState.guessing--;
			}
			if ( synPredMatched7067 ) {
				x=incOrDec();
			}
			else if ((LA(1)==BANG)) {
				b = LT(1);
	...
	public final Expression  shiftExpr() throws RecognitionException, TokenStreamException {
		...
		try {      // for error handling
			boolean synPredMatched7062 = false;
			if (((LA(1)==ID))) {
				int _m7062 = mark();
				synPredMatched7062 = true;
				inputState.guessing++;
				try {
					{
					left_expr();
					...
					synPredMatched7062 = false;
				}
				rewind(_m7062);
				inputState.guessing--;
			}
			if ( synPredMatched7062 ) {
				x=left_expr();
				match(RSHIFT);
				amt=value_expr();
				if ( inputState.guessing==0 ) {
				...
				boolean synPredMatched7064 = false;
				if (((LA(1)==ID))) {
					int _m7064 = mark();
					synPredMatched7064 = true;
					inputState.guessing++;
					try {
						{
						left_expr();
						...
						synPredMatched7064 = false;
					}
					rewind(_m7064);
					inputState.guessing--;
				}
				if ( synPredMatched7064 ) {
					x=left_expr();
					match(LSHIFT);
					amt=value_expr();
					if ( inputState.guessing==0 ) {
	...
	public final Expression  minic_value_expr() throws RecognitionException, TokenStreamException {
		...
		try {      // for error handling
			...
			default:
				boolean synPredMatched7079 = false;
				if (((LA(1)==ID))) {
					int _m7079 = mark();
					synPredMatched7079 = true;
					inputState.guessing++;
					try {
						{
						func_call();
						...
						synPredMatched7079 = false;
					}
					rewind(_m7079);
					inputState.guessing--;
				}
				if ( synPredMatched7079 ) {
					x=func_call();
				}
				else if ((LA(1)==ID)) {
					x=value();
