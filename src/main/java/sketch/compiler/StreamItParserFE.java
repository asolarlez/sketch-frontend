  ...
  tokenNames = _tokenNames;
	...
	public final Program  program() throws RecognitionException, TokenStreamException {
		...
		try {      // for error handling
			...
			_loop2468:
			do {
				boolean synPredMatched2467 = false;
				if (((_tokenSet_0.member(LA(1))))) {
					int _m2467 = mark();
					synPredMatched2467 = true;
					inputState.guessing++;
					try {
						{
						return_types();
						...
						synPredMatched2467 = false;
					}
					rewind(_m2467);
					inputState.guessing--;
				}
				if ( synPredMatched2467 ) {
					f=function_decl();
	...
	public final Expression  var_initializer() throws RecognitionException, TokenStreamException {
		...
		try {      // for error handling
			boolean synPredMatched2563 = false;
			if (((LA(1)==LCURLY))) {
				int _m2563 = mark();
				synPredMatched2563 = true;
				inputState.guessing++;
				try {
					{
					arr_initializer();
					...
					synPredMatched2563 = false;
				}
				rewind(_m2563);
				inputState.guessing--;
			}
			if ( synPredMatched2563 ) {
				x=arr_initializer();
			}
		...
		try {      // for error handling
			...
			default:
				...
				if ( synPredMatched2486 ) {
					...
					boolean synPredMatched2488 = false;
					if (((_tokenSet_12.member(LA(1))))) {
						int _m2488 = mark();
						synPredMatched2488 = true;
						inputState.guessing++;
						try {
							{
							expr_statement();
							...
							synPredMatched2488 = false;
						}
						rewind(_m2488);
						inputState.guessing--;
					}
					if ( synPredMatched2488 ) {
						s=expr_statement();
						match(SEMI);
					}
				else {
	...
	public final Statement  expr_statement() throws RecognitionException, TokenStreamException {
		...
		try {      // for error handling
			boolean synPredMatched2546 = false;
			if (((LA(1)==INCREMENT||LA(1)==DECREMENT||LA(1)==ID))) {
				int _m2546 = mark();
				synPredMatched2546 = true;
				inputState.guessing++;
				try {
					{
					incOrDec();
					...
					synPredMatched2546 = false;
				}
				rewind(_m2546);
				inputState.guessing--;
			}
			if ( synPredMatched2546 ) {
				x=incOrDec();
				if ( inputState.guessing==0 ) {
					s = new StmtExpr(x);
				}
				...
				boolean synPredMatched2549 = false;
				if (((LA(1)==ID))) {
					int _m2549 = mark();
					synPredMatched2549 = true;
					inputState.guessing++;
					try {
						{
						left_expr();
						...
						synPredMatched2549 = false;
					}
					rewind(_m2549);
					inputState.guessing--;
				}
				if ( synPredMatched2549 ) {
					s=assign_expr();
				}
				else {
					boolean synPredMatched2551 = false;
					if (((LA(1)==ID))) {
						int _m2551 = mark();
						synPredMatched2551 = true;
						inputState.guessing++;
						try {
							{
							match(ID);
							...
							synPredMatched2551 = false;
						}
						rewind(_m2551);
						inputState.guessing--;
					}
					if ( synPredMatched2551 ) {
						x=func_call();
						if ( inputState.guessing==0 ) {
							s = new StmtExpr(x);
						}
	...
	public final Statement  if_else_statement() throws RecognitionException, TokenStreamException {
		...
		try {      // for error handling
			...
			t=pseudo_block();
			{
			boolean synPredMatched2530 = false;
			if (((LA(1)==TK_else))) {
				int _m2530 = mark();
				synPredMatched2530 = true;
				inputState.guessing++;
				try {
					{
					match(TK_else);
					...
					synPredMatched2530 = false;
				}
				rewind(_m2530);
				inputState.guessing--;
			}
			if ( synPredMatched2530 ) {
				{
				match(TK_else);
				f=pseudo_block();
				}
	...
	public final SplitterJoiner  splitter_or_joiner() throws RecognitionException, TokenStreamException {
		...
		try {      // for error handling
			...
			case TK_roundrobin:
			{
				...
				match(TK_roundrobin);
				{
				boolean synPredMatched2495 = false;
				if (((LA(1)==LPAREN))) {
					int _m2495 = mark();
					synPredMatched2495 = true;
					inputState.guessing++;
					try {
						{
						match(LPAREN);
						...
						synPredMatched2495 = false;
					}
					rewind(_m2495);
					inputState.guessing--;
				}
				if ( synPredMatched2495 ) {
					match(LPAREN);
					match(RPAREN);
					if ( inputState.guessing==0 ) {
	...
	public final Statement  for_init_statement() throws RecognitionException, TokenStreamException {
		...
		try {      // for error handling
			boolean synPredMatched2538 = false;
			if (((_tokenSet_0.member(LA(1))))) {
				int _m2538 = mark();
				synPredMatched2538 = true;
				inputState.guessing++;
				try {
					{
					variable_decl();
					...
					synPredMatched2538 = false;
				}
				rewind(_m2538);
				inputState.guessing--;
			}
			if ( synPredMatched2538 ) {
				s=variable_decl();
			}
			else {
				boolean synPredMatched2540 = false;
				if (((_tokenSet_12.member(LA(1))))) {
					int _m2540 = mark();
					synPredMatched2540 = true;
					inputState.guessing++;
					try {
						{
						expr_statement();
						...
						synPredMatched2540 = false;
					}
					rewind(_m2540);
					inputState.guessing--;
				}
				if ( synPredMatched2540 ) {
					s=expr_statement();
				}
				else {
					boolean synPredMatched2542 = false;
					if (((LA(1)==SEMI))) {
						int _m2542 = mark();
						synPredMatched2542 = true;
						inputState.guessing++;
						try {
							{
							match(SEMI);
							...
							synPredMatched2542 = false;
						}
						rewind(_m2542);
						inputState.guessing--;
					}
					if ( synPredMatched2542 ) {
						if ( inputState.guessing==0 ) {
	...
	public final Expression  inc_dec_expr() throws RecognitionException, TokenStreamException {
		...
		try {      // for error handling
			boolean synPredMatched2609 = false;
			if (((LA(1)==INCREMENT||LA(1)==DECREMENT||LA(1)==ID))) {
				int _m2609 = mark();
				synPredMatched2609 = true;
				inputState.guessing++;
				try {
					{
					incOrDec();
					...
					synPredMatched2609 = false;
				}
				rewind(_m2609);
				inputState.guessing--;
			}
			if ( synPredMatched2609 ) {
				x=incOrDec();
			}
			else if ((LA(1)==BANG)) {
				b = LT(1);
	...
	public final Expression  shiftExpr() throws RecognitionException, TokenStreamException {
		...
		try {      // for error handling
			boolean synPredMatched2604 = false;
			if (((_tokenSet_30.member(LA(1))))) {
				int _m2604 = mark();
				synPredMatched2604 = true;
				inputState.guessing++;
				try {
					{
					minic_value_expr();
					...
					synPredMatched2604 = false;
				}
				rewind(_m2604);
				inputState.guessing--;
			}
			if ( synPredMatched2604 ) {
				x=minic_value_expr();
				match(RSHIFT);
				amt=value_expr();
				if ( inputState.guessing==0 ) {
				...
				boolean synPredMatched2606 = false;
				if (((_tokenSet_30.member(LA(1))))) {
					int _m2606 = mark();
					synPredMatched2606 = true;
					inputState.guessing++;
					try {
						{
						minic_value_expr();
						...
						synPredMatched2606 = false;
					}
					rewind(_m2606);
					inputState.guessing--;
				}
				if ( synPredMatched2606 ) {
					x=minic_value_expr();
					match(LSHIFT);
					amt=value_expr();
					if ( inputState.guessing==0 ) {
	...
	public final Expression  minic_value_expr() throws RecognitionException, TokenStreamException {
		...
		try {      // for error handling
			...
			default:
				boolean synPredMatched2620 = false;
				if (((LA(1)==ID))) {
					int _m2620 = mark();
					synPredMatched2620 = true;
					inputState.guessing++;
					try {
						{
						func_call();
						...
						synPredMatched2620 = false;
					}
					rewind(_m2620);
					inputState.guessing--;
				}
				if ( synPredMatched2620 ) {
					x=func_call();
				}
				else if ((LA(1)==ID)) {
					x=value();
