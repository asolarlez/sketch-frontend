  ...
  tokenNames = _tokenNames;
	...
	public final Program  program() throws RecognitionException, TokenStreamException {
		...
		try {      // for error handling
			...
			_loop2963:
			do {
				boolean synPredMatched2962 = false;
				if (((_tokenSet_0.member(LA(1))))) {
					int _m2962 = mark();
					synPredMatched2962 = true;
					inputState.guessing++;
					try {
						{
						return_types();
						...
						synPredMatched2962 = false;
					}
					rewind(_m2962);
					inputState.guessing--;
				}
				if ( synPredMatched2962 ) {
					f=function_decl();
	...
	public final StreamSpec  filter_body(
		...
		try {      // for error handling
			...
			do {
				...
				default:
					boolean synPredMatched2971 = false;
					if (((_tokenSet_0.member(LA(1))))) {
						int _m2971 = mark();
						synPredMatched2971 = true;
						inputState.guessing++;
						try {
							{
							data_type();
							...
							synPredMatched2971 = false;
						}
						rewind(_m2971);
						inputState.guessing--;
					}
					if ( synPredMatched2971 ) {
						fn=function_decl();
						if ( inputState.guessing==0 ) {
							funcs.add(fn);
						}
	...
	public final Statement  statement() throws RecognitionException, TokenStreamException {
		...
		try {      // for error handling
			...
			default:
				boolean synPredMatched2990 = false;
				if (((_tokenSet_0.member(LA(1))))) {
					int _m2990 = mark();
					synPredMatched2990 = true;
					inputState.guessing++;
					try {
						{
						data_type();
						...
						synPredMatched2990 = false;
					}
					rewind(_m2990);
					inputState.guessing--;
				}
				if ( synPredMatched2990 ) {
					s=variable_decl();
					match(SEMI);
				}
				else {
					boolean synPredMatched2992 = false;
					if (((_tokenSet_14.member(LA(1))))) {
						int _m2992 = mark();
						synPredMatched2992 = true;
						inputState.guessing++;
						try {
							{
							expr_statement();
							...
							synPredMatched2992 = false;
						}
						rewind(_m2992);
						inputState.guessing--;
					}
					if ( synPredMatched2992 ) {
						s=expr_statement();
						match(SEMI);
					}
				else {
	...
	public final Statement  expr_statement() throws RecognitionException, TokenStreamException {
		...
		try {      // for error handling
			boolean synPredMatched3050 = false;
			if (((LA(1)==INCREMENT||LA(1)==DECREMENT||LA(1)==ID))) {
				int _m3050 = mark();
				synPredMatched3050 = true;
				inputState.guessing++;
				try {
					{
					incOrDec();
					...
					synPredMatched3050 = false;
				}
				rewind(_m3050);
				inputState.guessing--;
			}
			if ( synPredMatched3050 ) {
				x=incOrDec();
				if ( inputState.guessing==0 ) {
					s = new StmtExpr(x);
				}
				...
				boolean synPredMatched3053 = false;
				if (((LA(1)==ID))) {
					int _m3053 = mark();
					synPredMatched3053 = true;
					inputState.guessing++;
					try {
						{
						left_expr();
						...
						synPredMatched3053 = false;
					}
					rewind(_m3053);
					inputState.guessing--;
				}
				if ( synPredMatched3053 ) {
					s=assign_expr();
				}
				else {
					boolean synPredMatched3055 = false;
					if (((LA(1)==ID))) {
						int _m3055 = mark();
						synPredMatched3055 = true;
						inputState.guessing++;
						try {
							{
							match(ID);
							...
							synPredMatched3055 = false;
						}
						rewind(_m3055);
						inputState.guessing--;
					}
					if ( synPredMatched3055 ) {
						x=func_call();
						if ( inputState.guessing==0 ) {
							s = new StmtExpr(x);
						}
	...
	public final Statement  if_else_statement() throws RecognitionException, TokenStreamException {
		...
		try {      // for error handling
			...
			t=pseudo_block();
			{
			boolean synPredMatched3034 = false;
			if (((LA(1)==TK_else))) {
				int _m3034 = mark();
				synPredMatched3034 = true;
				inputState.guessing++;
				try {
					{
					match(TK_else);
					...
					synPredMatched3034 = false;
				}
				rewind(_m3034);
				inputState.guessing--;
			}
			if ( synPredMatched3034 ) {
				{
				match(TK_else);
				f=pseudo_block();
				}
	...
	public final SplitterJoiner  splitter_or_joiner() throws RecognitionException, TokenStreamException {
		...
		try {      // for error handling
			...
			case TK_roundrobin:
			{
				...
				match(TK_roundrobin);
				{
				boolean synPredMatched2999 = false;
				if (((LA(1)==LPAREN))) {
					int _m2999 = mark();
					synPredMatched2999 = true;
					inputState.guessing++;
					try {
						{
						match(LPAREN);
						...
						synPredMatched2999 = false;
					}
					rewind(_m2999);
					inputState.guessing--;
				}
				if ( synPredMatched2999 ) {
					match(LPAREN);
					match(RPAREN);
					if ( inputState.guessing==0 ) {
					...
					boolean synPredMatched3001 = false;
					if (((LA(1)==LPAREN))) {
						int _m3001 = mark();
						synPredMatched3001 = true;
						inputState.guessing++;
						try {
							{
							match(LPAREN);
							...
							synPredMatched3001 = false;
						}
						rewind(_m3001);
						inputState.guessing--;
					}
					if ( synPredMatched3001 ) {
						match(LPAREN);
						x=right_expr();
						match(RPAREN);
						if ( inputState.guessing==0 ) {
	...
	public final Statement  for_init_statement() throws RecognitionException, TokenStreamException {
		...
		try {      // for error handling
			boolean synPredMatched3042 = false;
			if (((_tokenSet_0.member(LA(1))))) {
				int _m3042 = mark();
				synPredMatched3042 = true;
				inputState.guessing++;
				try {
					{
					variable_decl();
					...
					synPredMatched3042 = false;
				}
				rewind(_m3042);
				inputState.guessing--;
			}
			if ( synPredMatched3042 ) {
				s=variable_decl();
			}
			else {
				boolean synPredMatched3044 = false;
				if (((_tokenSet_14.member(LA(1))))) {
					int _m3044 = mark();
					synPredMatched3044 = true;
					inputState.guessing++;
					try {
						{
						expr_statement();
						...
						synPredMatched3044 = false;
					}
					rewind(_m3044);
					inputState.guessing--;
				}
				if ( synPredMatched3044 ) {
					s=expr_statement();
				}
				else {
					boolean synPredMatched3046 = false;
					if (((LA(1)==SEMI))) {
						int _m3046 = mark();
						synPredMatched3046 = true;
						inputState.guessing++;
						try {
							{
							match(SEMI);
							...
							synPredMatched3046 = false;
						}
						rewind(_m3046);
						inputState.guessing--;
					}
					if ( synPredMatched3046 ) {
						if ( inputState.guessing==0 ) {
	...
	public final Expression  inc_dec_expr() throws RecognitionException, TokenStreamException {
		...
		try {      // for error handling
			boolean synPredMatched3109 = false;
			if (((LA(1)==INCREMENT||LA(1)==DECREMENT||LA(1)==ID))) {
				int _m3109 = mark();
				synPredMatched3109 = true;
				inputState.guessing++;
				try {
					{
					incOrDec();
					...
					synPredMatched3109 = false;
				}
				rewind(_m3109);
				inputState.guessing--;
			}
			if ( synPredMatched3109 ) {
				x=incOrDec();
			}
			else if ((LA(1)==BANG)) {
				b = LT(1);
	...
	public final Expression  shiftExpr() throws RecognitionException, TokenStreamException {
		...
		try {      // for error handling
			boolean synPredMatched3104 = false;
			if (((_tokenSet_34.member(LA(1))))) {
				int _m3104 = mark();
				synPredMatched3104 = true;
				inputState.guessing++;
				try {
					{
					minic_value_expr();
					...
					synPredMatched3104 = false;
				}
				rewind(_m3104);
				inputState.guessing--;
			}
			if ( synPredMatched3104 ) {
				x=minic_value_expr();
				match(RSHIFT);
				amt=value_expr();
				if ( inputState.guessing==0 ) {
				...
				boolean synPredMatched3106 = false;
				if (((_tokenSet_34.member(LA(1))))) {
					int _m3106 = mark();
					synPredMatched3106 = true;
					inputState.guessing++;
					try {
						{
						minic_value_expr();
						...
						synPredMatched3106 = false;
					}
					rewind(_m3106);
					inputState.guessing--;
				}
				if ( synPredMatched3106 ) {
					x=minic_value_expr();
					match(LSHIFT);
					amt=value_expr();
					if ( inputState.guessing==0 ) {
	...
	public final Expression  minic_value_expr() throws RecognitionException, TokenStreamException {
		...
		try {      // for error handling
			...
			default:
				boolean synPredMatched3121 = false;
				if (((LA(1)==ID))) {
					int _m3121 = mark();
					synPredMatched3121 = true;
					inputState.guessing++;
					try {
						{
						func_call();
						...
						synPredMatched3121 = false;
					}
					rewind(_m3121);
					inputState.guessing--;
				}
				if ( synPredMatched3121 ) {
					x=func_call();
				}
				else if ((LA(1)==ID)) {
					x=value();
	...
	private static final long[] mk_tokenSet_12() {
		long[] data = { 1657324680035435010L, 68732059648L, 0L, 0L};
		return data;
	}
