...
// on Sunday, October 2, 2016 at 4:37:25 PM.
  ...
  private Result pExprPrimary$1(final int yyStart) throws IOException {
    ...
    if (yyResult.hasValue()) {
      ...
      if (yyResult.hasValue()) {
        ...
        for (Selector s : l)  if (s == null) yyValue = new ExprField(yyValue,yyValue,"", true); else yyValue = new ExprChoiceSelect (yyValue, s);
