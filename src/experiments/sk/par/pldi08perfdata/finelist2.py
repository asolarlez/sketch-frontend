...
test ('fine-locking_list-based_set/soln_3_a-r-a-r-a-r.sk', extraopts=o),
test ('fine-locking_list-based_set/sketch1_3_a-r-a-r-a-r.sk', extraopts=o),
test ('fine-locking_list-based_set/sketch2_3_a-r-a-r-a-r.sk', extraopts=o),

# - 4 threads, 4 concurrent ops
test ('fine-locking_list-based_set/soln_4_a-r-a-r.sk', extraopts=o),
test ('fine-locking_list-based_set/sketch1_4_a-r-a-r.sk', extraopts=o),
test ('fine-locking_list-based_set/sketch2_4_a-r-a-r.sk', extraopts=o),
)
