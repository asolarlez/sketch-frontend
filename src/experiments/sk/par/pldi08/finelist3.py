...
test ('benchmarks/fine-locking_list-based_set/soln_4_a-a-r-r-a-a-r-r.sk', extraopts=o),
test ('benchmarks/fine-locking_list-based_set/soln_4_a-r-a-r-a-r-a-r.sk', extraopts=o),
)
