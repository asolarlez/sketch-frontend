...
test ('benchmarks/lazy_list-based_set/lzsoln_2_a-a-r-r.sk', extraopts=o),
test ('benchmarks/lazy_list-based_set/lzsoln_2_a-r-a-r.sk', extraopts=o),

test ('benchmarks/lazy_list-based_set/lzsketch1_2_a-a-r-r.sk', extraopts=o),
test ('benchmarks/lazy_list-based_set/lzsketch1_2_a-r-a-r.sk', extraopts=o),
